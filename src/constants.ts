...
export const SUPPORTED_LLM_PROVIDERS = ["gemini", "chatgpt", "anthropic", "felo"] as const;
...
export const SUPPORTED_NEWS_PROVIDERS = ["google_rss", "gnews", "auto", "llm"] as const;
